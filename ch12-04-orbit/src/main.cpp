...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(400, 400), "Orbit", sf::Style::Titlebar | sf::Style::Close,
                            context);
    ...
    Ball planet(window.getSize().x / 2 + 200, window.getSize().y / 2, 10, sf::Color(0, 255, 0));
    planet.mass = 1;
    planet.vy = 7;
