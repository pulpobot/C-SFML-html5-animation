...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(400, 400), "Two Segments 2", sf::Style::Titlebar | sf::Style::Close,
                            context);
    ...
    while (window.isOpen()) {
        ...
        segment1.SetRotation(segment0.shape.getRotation() + slider1.value);
